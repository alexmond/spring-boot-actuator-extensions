- **3.5.16.1**
* Upgraded Spring Boot to 3.5.16 (`3.5` maintenance line).
- **3.5.15.1**
...
* Adopted a Boot-tracking version scheme: the project version is now `<spring-boot-version>.x` (e.g. `3.5.15.1`).
